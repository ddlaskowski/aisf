...
export function renderGovernanceControlledProjectGenerationContractBundleHelp(): string {
  return [
    ...
    "  This is preview-only and read-only. It has no runtime execution, no runtime activation, no runtime routing, no runtime persistence, no contract bundle execution, no runtime, and no project generation.",
